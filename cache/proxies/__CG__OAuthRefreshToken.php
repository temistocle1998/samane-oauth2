 ...
 */
class OAuthRefreshToken extends \OAuthRefreshToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OAuthRefreshToken' . "\0" . 'id', '' . "\0" . 'OAuthRefreshToken' . "\0" . 'refresh_token', '' . "\0" . 'OAuthRefreshToken' . "\0" . 'expires', '' . "\0" . 'OAuthRefreshToken' . "\0" . 'scope', '' . "\0" . 'OAuthRefreshToken' . "\0" . 'client_id', '' . "\0" . 'OAuthRefreshToken' . "\0" . 'user_id'];
        }
    ...
    public function setRefreshToken($refresh_token)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRefreshToken', [$refresh_token]);

        return parent::setRefreshToken($refresh_token);
    }
