 ...
 */
class OAuthAuthorizationCode extends \OAuthAuthorizationCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OAuthAuthorizationCode' . "\0" . 'id', '' . "\0" . 'OAuthAuthorizationCode' . "\0" . 'code', '' . "\0" . 'OAuthAuthorizationCode' . "\0" . 'user_id', '' . "\0" . 'OAuthAuthorizationCode' . "\0" . 'expires', '' . "\0" . 'OAuthAuthorizationCode' . "\0" . 'redirect_uri', '' . "\0" . 'OAuthAuthorizationCode' . "\0" . 'scope', '' . "\0" . 'OAuthAuthorizationCode' . "\0" . 'client_id', '' . "\0" . 'OAuthAuthorizationCode' . "\0" . 'user'];
        }
